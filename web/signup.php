...
<body>
	...
	<div class="form-container">
		<form method="post">
			<div style="font-size: 30px;  margin-top: 0px; margin-right: 300px; color: black;">User Name</div>
			...
			<input id="text" type="password" name="confirm_password" placeholder="Confirm Password"
				style="margin: 5px; background-color: #E9B265; color: white; border-radius: 5px; border: none; text-align: center; padding: 15px 100px; font-size: 20px;"><br><br>
			<?php
			echo "<div class='error-message' style='margin: 0px 0px 0px 80px; '>$error_message</div>";
			?>

			<input id="button" type="submit" value="Sign Up"
				style="border-radius: 10px; background-color: #E9B265; border-color: #E9B265; padding: 20px 120px; font-size: 60px; margin-top: 5px; display: block; margin-left: 200px;"><br><br>

		</form>
		<div class="signup">
			<a href="login.php"
				style="font-size: 30px; color: #000000; display: block; text-align: center; margin-top: -30px; margin-left: 220px;">Login</a>
		</div>
	</div>
